...
/*
 Value Types:
    ...
    sealed > means other types can't inherit from them, so can't have a virtual or abstract members
    stored on the stack
...
/*
 If you want the modification to the integer parameter to affect the variable that was passed
 to a method, you should use ref keyword before the parameter
 */
